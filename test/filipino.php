    ...
    <section>
        ...
        <div>
            ...
            <div class="exam-test">
                ...
                <form action="filipino.php" method="POST">
...
<div class="inform">
    ...
    <a href="http://localhost/exam/recommendation/results.php?">
        <h4 id="button" style="margin-right: 29%; margin-top: -2%;">SEE RESULTS</h4>
    </form>
    </a>
</div>
