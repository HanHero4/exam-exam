    ...
    <section>
        ...
        <div class="content">
            <div class="info">
                <h1>ABOUT</h1>
                <p>
                    An Examination System is an automated conducting of examination or test to students. This can help
                    measure
                    their academic excellence and potential. Over the corse of the century, these evaluations were
                    conducted
                    orally or through written mediums, those that uses pen and paper. However, as the technology
                    advances yet
                    more and more, this new form of examination becomes more and more standard than ever before.
                </p>
            </div>
        </div>
